...
export default function Company({ handleNext }: { handleNext: () => void }) {
  ...
  return (
    <MotionContainer>
      <div className='container mx-auto flex h-full flex-col items-center justify-center gap-5 rounded-xl bg-white px-10 py-10 shadow-md sm:px-16 md:px-32 lg:w-1/2'>
        <motion.div
          variants={varFade().in}
          className='flex h-full w-full flex-col items-center gap-6'
        >
          <h1 className='text-3xl font-semibold text-secondary-900'>
            {t("Let's set up your company")}
          </h1>

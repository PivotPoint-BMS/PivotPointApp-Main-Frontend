...
export default function Subscription({ handleBack, handleNext, isLoading }: SubscriptionProps) {
  ...
  return (
    <>
      <MotionContainer>
        <div className='container relative mx-auto flex h-full flex-col items-center justify-center gap-5 rounded-xl bg-white px-5 py-10 shadow-md sm:px-16 md:px-20'>
          <IconButton
            onClick={handleBack}
            ...
            <div className='flex items-center justify-between'>
              <MotionContainer>
                <div className='divide- grid grid-cols-1 items-center justify-around divide-x divide-y divide-dashed divide-gray-400 overflow-hidden rounded-lg border border-dashed border-gray-400 rtl:divide-x-reverse lg:grid-cols-3 lg:divide-y-0'>
                  <div className='duration- flex h-full flex-col bg-white p-10 transition-all'>
                    ...
                    <p className='mb-10 flex-1 leading-loose text-gray-600'>
                      {t(
                    ...
                    <h3 className='mb-10 text-5xl'>
                      ...
                      <span className='text-sm text-gray-600'> {t('per month')}</span>
                    </h3>
                  ...
                  <div className='flex flex-col bg-white p-10 transition-all duration-500'>
                    <div className='mb-3 flex items-center gap-2'>
                      <Iconify
                  ...
                  <div className='flex h-full flex-col bg-white p-10 transition-all duration-500'>

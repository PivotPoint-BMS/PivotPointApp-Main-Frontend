...
export default function ContactTableToolbar({ selectedCount }: LeadTableToolbarProps) {
  ...
  return (
    ...
    >
      <div className='flex h-full items-center gap-4 rounded-lg border border-dashed border-gray-400 bg-white py-1 px-4  drop-shadow-xl dark:bg-paper-dark'>
        <div className='flex h-full w-max  items-center gap-4 border-r border-dashed border-gray-400 py-1 pr-4'>

...
function SideBar() {
  ...
  return (
    <div className='relative'>
      ...
      >
        <div
          className='group fixed z-10 flex h-screen flex-col items-start bg-gray-50 py-6 px-4 transition-all  hover:overflow-y-auto ltr:border-r rtl:border-l motion-reduce:transition-none dark:border-gray-500 dark:bg-dark'

...
export const badgeContained = cva(
  "flex truncate w-max items-center justify-center text-xs rounded py-1 font-bold select-none",
  {
    variants: {
      intent: {
...
export const badgeOutlined = cva(
  "flex truncate items-center w-max text-xs rounded py-1 font-bold select-none",
  {
    variants: {
      intent: {
...
export const badgeGhost = cva(
  "flex truncate items-start justify-center w-max rounded py-1 font-bold select-none",
  {
    variants: {
      intent: {
        primary:
